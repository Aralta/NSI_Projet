...
GRID1 = [
    ...
    [zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz],
    [zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz],
    [zz,zz,zz,zz,zz,ci,cj,ck,cl,cm,cn,co,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,bi,bj,bj,bj,bj,bj,bj,bj],
    [zz,zz,zz,zz,zz,cf,cg,cg,cg,cg,cg,ch,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,bf,bg,bg,bg,bg,bg,bg,bg],
    [zz,zz,zz,zz,zz,by,bz,ca,cb,cc,cd,ce,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,bf,bg,bg,bg,bg,bg,bg,bg],
    [zz,zz,zz,zz,zz,aa,ab,ac,ad,ae,af,ag,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,zz,bf,bg,bg,bg,bg,bg,bg,bg],
